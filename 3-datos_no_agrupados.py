...
# ----------------------------------------------------------------------
    ...
    st.markdown("""
    Una **proporción** es una relación o comparación entre dos cantidades. Nos indica que tan grande es una cantidad con respecto a otra. Se expresa como un número positivo mayor o igual que 0.
    """)
